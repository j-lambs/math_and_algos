...
![](images/000010.png?resize=13.jpg)
...
![](images/000012.png?resize=14.jpg)
...
![](images/000010.png?resize=15.jpg)
...
![](images/000010.png?resize=16.jpg)
...
![](images/000010.png?resize=17.jpg)
...
![](images/000010.png?resize=18.jpg)
...
![](images/000010.png?resize=19.jpg)
...
![](images/000010.png?resize=20.jpg)
...
![](images/000014.png?resize=12.jpg)
...
mdc <- read_csv("/Users/rellamas/where is math stuff/R/data/Monthly_Counts_of_Deaths_by_Select_Causes__2014-2019.csv")
```
...
These 3 causes did not follow my assumption that there would be an increase in self-harming and violent behavior in the winter. I assumed that seasonal depression would drive more people to destructive behavior.
A possible explanation for the increase in homicides in the summer is that there are more people going out than in the colder months, so there are more opportunities for violence between people.
There is also always a dip in February for every cause of death. I assume this is because February only has 28 days per month where the other months have 30 or 31 days.
